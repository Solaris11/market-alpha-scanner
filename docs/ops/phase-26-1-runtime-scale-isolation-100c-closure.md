...
- Kept the initial discovery packet to 160 rows and extended stale-safe cache windows so background refreshes are less likely to contend with sustained 100c traffic.
