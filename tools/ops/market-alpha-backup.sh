...
BACKUP_ENV_OVERRIDE_NAMES=(
  ...
  MARKET_ALPHA_BACKUP_R2_SYNC_ATTEMPTS
...
R2_SYNC_TIMEOUT_SECONDS="${MARKET_ALPHA_BACKUP_R2_SYNC_TIMEOUT_SECONDS:-18000}"
R2_SYNC_ATTEMPTS="${MARKET_ALPHA_BACKUP_R2_SYNC_ATTEMPTS:-1}"
