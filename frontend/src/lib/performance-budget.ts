...
export const PERFORMANCE_ROUTE_BUDGETS: PerformanceBudgetRoute[] = [
  ...
  { budgetMs: 3_000, method: "GET", path: "/feed", surface: "intelligence" },
  { budgetMs: 3_500, method: "GET", path: "/macro", surface: "intelligence" },
  { budgetMs: 4_000, method: "GET", path: "/market-memory", surface: "intelligence" },
