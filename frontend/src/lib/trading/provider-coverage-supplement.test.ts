...
test("selects supplemental events across analyst, geopolitical, and inflation domains", async () => {
  ...
  const events = await fetchSupplementalProviderEvents({ fetcher, limit: 3, now: new Date("2026-05-28T12:00:00.000Z") });
