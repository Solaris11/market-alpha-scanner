...
export function TerminalHeader() {
  return (
    <header className="visual-card visual-card-overflow-visible poster-panel tv-card-motion sticky top-3 z-40 mb-4 rounded-[1.4rem] border border-cyan-300/18 bg-slate-950/88 px-3 py-3 shadow-2xl shadow-cyan-950/20 ring-1 ring-white/5 backdrop-blur-2xl lg:px-5 lg:py-4">
