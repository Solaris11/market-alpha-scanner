...
export function ExecutionTicket({ symbol, qty, limitPrice, stopPrice }: { symbol: string; qty: number; limitPrice?: number; stopPrice?: number }) {
  ...
  return (
    <GlassPanel className="p-5">
      ...
      <button className="mt-4 w-full rounded-xl bg-cyan-300 px-4 py-2 text-sm font-bold text-slate-950 transition-all hover:bg-cyan-200 disabled:opacity-50" disabled={!ticket.validation.valid} onClick={() => setConfirming(true)}>Review Mock Order</button>
