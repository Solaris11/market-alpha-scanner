...
export async function TerminalShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <main className="app-aurora-surface tv-cinematic-shell tv-page-motion min-h-screen overflow-x-hidden px-3 pb-[calc(7rem+env(safe-area-inset-bottom))] pt-3 text-slate-100 sm:px-4 sm:pb-6 sm:pt-4 xl:pb-4">
      <CinematicAtmosphere />
