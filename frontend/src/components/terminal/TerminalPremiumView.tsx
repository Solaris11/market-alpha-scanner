...
import { buildOpportunitiesPageModel, stripNarrativeForTerminal, stripRawFields, stripShockEventsForClient } from "@/lib/trading/opportunity-view-model";
...
export async function TerminalPremiumView({ entitlement }: { entitlement: TerminalEntitlement }) {
  ...
  const clientRows = timeline.sync("stripForClient", () => stripNarrativeForTerminal(stripRawFields(stripShockEventsForClient(opportunityModel.rows))),
