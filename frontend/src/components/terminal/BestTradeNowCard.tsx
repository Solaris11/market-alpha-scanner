        ...
        <div className="grid min-w-0 gap-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-end">
          <div className="min-w-0">
            ...
            <div className="mt-4 flex min-w-0 flex-wrap items-center gap-3">
              <Link className="min-w-0 font-mono text-4xl font-black tracking-tight text-slate-50 transition hover:text-cyan-100 sm:text-5xl md:text-6xl" href={`/symbol/${row.symbol}`}>{row.symbol}</Link>
            ...
            <div className="mt-5 flex min-w-0 flex-wrap gap-3" data-onboarding-target="trade-plan-entry">
              <Link className="font-mono text-sm font-bold text-cyan-100 transition hover:text-cyan-50" href={`/symbol/${row.symbol}`}>
