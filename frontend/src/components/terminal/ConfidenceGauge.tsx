  ...
  return (
    <div>
      ...
      <div className="h-3 overflow-hidden rounded-full bg-slate-800/80">
        <div className="tv-chart-reveal h-full rounded-full bg-gradient-to-r from-rose-400 via-amber-300 to-emerald-300 shadow-[0_0_18px_rgba(45,212,191,0.35)]" style={{ width: `${percent}%` }} />
      </div>
    </div>
  );
}
