...
export const metadata: Metadata = marketingMetadata("/faq", {
  title: "FAQ — Market Alpha Scanner",
  description: "Frequently asked questions about Market Alpha Scanner, an AI-powered trading research platform and decision-support system.",
});

const faqs = [
  ["Is Market Alpha Scanner financial advice?", "No. It is research and education software. It does not provide personalized investment advice, brokerage services, or guaranteed outcomes."],
  ["Is this a trading bot?", "No. Market Alpha Scanner does not place trades. It helps you evaluate whether a setup is worth researching, watching, avoiding, or waiting on."],
  ...
  return (
    <MarketingShell>
      <section className="px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SectionHeader copy="Short answers for traders evaluating whether Market Alpha Scanner fits their workflow." eyebrow="FAQ" title="Built for research, discipline, and risk awareness." />
