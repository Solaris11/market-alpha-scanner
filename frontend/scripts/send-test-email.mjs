...
const config = {
  from: process.env.EMAIL_FROM || "Market Alpha Scanner <noreply@marketalpha.co>",
  host: process.env.SMTP_HOST,
  pass: process.env.SMTP_PASS,
  port: Number(process.env.SMTP_PORT || 587),
  replyTo: process.env.SUPPORT_EMAIL || "support@marketalpha.co",
...
console.log(JSON.stringify({ ok: Boolean(result.messageId), to }));
